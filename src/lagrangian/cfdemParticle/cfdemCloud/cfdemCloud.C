...
//_AO- Particle angular velocity
        //dataExchangeM().allocateArray(fluidVel_,0.,3,1);
        //dataExchangeM().allocateArray(impForces_,0.,3,1);
        //dataExchangeM().allocateArray(expForces_,0.,3,1);
        //dataExchangeM().allocateArray(DEMForces_,0.,3,1);
        //dataExchangeM().allocateArray(Cds_,0.,1,1);
        //dataExchangeM().allocateArray(voidfractions_,1.,voidFractionM().maxCellsPerParticle());
        //dataExchangeM().allocateArray(particleWeights_,0.,voidFractionM().maxCellsPerParticle());
        //dataExchangeM().allocateArray(particleVolumes_,0.,voidFractionM().maxCellsPerParticle());
        arraysReallocated_ = true;
